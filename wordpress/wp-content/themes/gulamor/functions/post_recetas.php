...
function custom_post_type_recetas() {
	...
	$args = array(
		...
		'description'           => __( 'Post para publicar las recetas', 'text_domain' ),
		'labels'                => $labels,
	...
	register_post_type( 'post_recetas', $args );

}
add_action( 'init', 'custom_post_type_recetas', 0 );